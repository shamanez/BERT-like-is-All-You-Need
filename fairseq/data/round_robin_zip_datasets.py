...
class RoundRobinZipDatasets(FairseqDataset):
    ...
    def size(self, index):
        ...
        if len(size_dict)>1:
            ...
            assert size_dict['sup']==size_dict['unsup'],'Examples sizes from two datasets are not matching - They should match '
        ...
        return size_dict['sup']  #hacky as hell..  This way we assume both datasets
